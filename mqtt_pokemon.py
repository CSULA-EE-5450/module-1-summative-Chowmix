...
from pokemon_game import Battle, selection


# Broker options below, uncomment for one you want to use
...
async def post_battle_log(client, topic):
    message = "Welcome Trainers, please select your pokemon"
